...
# Table Data
config1_selected_data = globals()['config1_' + str(pressure_altitude) + '000_data']
config2_selected_data = globals()['config2_' + str(pressure_altitude) + '000_data']
config3_selected_data = globals()['config3_' + str(pressure_altitude) + '000_data']
# Runway Data
config1_selected_runwaydata = globals()['config1_' + str(pressure_altitude) + '000_runway_data']
config2_selected_runwaydata = globals()['config2_' + str(pressure_altitude) + '000_runway_data']
config3_selected_runwaydata = globals()['config3_' + str(pressure_altitude) + '000_runway_data']

# Determine closest runway length from table
closest_runway_length_config1_index = np.argmin(abs(config1_selected_runwaydata - runway_length))
closest_runway_length_config2_index = np.argmin(abs(config2_selected_runwaydata - runway_length))
closest_runway_length_config3_index = np.argmin(abs(config3_selected_runwaydata - runway_length))

# ---- CONFIG 1 ----
# Determine closest temperature from table
closest_temperature_config1_index = np.argmin(abs(config1_selected_data[:,0] - temperature))
temp = config1_selected_data[:,0]
original_temp_data = temp[closest_temperature_config1_index]
temp[closest_temperature_config1_index] = 1000
closest_temperature_config1_index1 = np.argmin(abs(temp - temperature))
temp[closest_temperature_config1_index] = original_temp_data

# First values
weight_config1_first = config1_selected_data[closest_temperature_config1_index, closest_runway_length_config1_index]
oat_config1_first = config1_selected_data[closest_temperature_config1_index, 0]
v1_config1_first = config1_selected_data[closest_temperature_config1_index, closest_runway_length_config1_index + 1]
vr_config1_first = config1_selected_data[closest_temperature_config1_index, closest_runway_length_config1_index + 2]
v2_config1_first = config1_selected_data[closest_temperature_config1_index, closest_runway_length_config1_index + 3]
# Second values
weight_config1_second = config1_selected_data[closest_temperature_config1_index1, closest_runway_length_config1_index]
oat_config1_second = config1_selected_data[closest_temperature_config1_index1, 0]
v1_config1_second = config1_selected_data[closest_temperature_config1_index1, closest_runway_length_config1_index + 1]
vr_config1_second = config1_selected_data[closest_temperature_config1_index1, closest_runway_length_config1_index + 2]
v2_config1_second = config1_selected_data[closest_temperature_config1_index1, closest_runway_length_config1_index + 3]

# ---- CONFIG 2 ----
# Determine closest temperature from table
closest_temperature_config2_index = np.argmin(abs(config2_selected_data[:,0] - temperature))
temp = config2_selected_data[:,0]
original_temp_data = temp[closest_temperature_config2_index]
temp[closest_temperature_config2_index] = 1000
closest_temperature_config2_index1 = np.argmin(abs(temp - temperature))
temp[closest_temperature_config2_index] = original_temp_data


# First values
weight_config2_first = config2_selected_data[closest_temperature_config2_index, closest_runway_length_config2_index]
oat_config2_first = config2_selected_data[closest_temperature_config2_index, 0]
v1_config2_first = config2_selected_data[closest_temperature_config2_index, closest_runway_length_config2_index + 1]
vr_config2_first = config2_selected_data[closest_temperature_config2_index, closest_runway_length_config2_index + 2]
v2_config2_first = config2_selected_data[closest_temperature_config2_index, closest_runway_length_config2_index + 3]
# Second values
weight_config2_second = config2_selected_data[closest_temperature_config2_index1, closest_runway_length_config2_index]
oat_config2_second = config2_selected_data[closest_temperature_config2_index1, 0]
v1_config2_second = config2_selected_data[closest_temperature_config2_index1, closest_runway_length_config2_index + 1]
vr_config2_second = config2_selected_data[closest_temperature_config2_index1, closest_runway_length_config2_index + 2]
v2_config2_second = config2_selected_data[closest_temperature_config2_index1, closest_runway_length_config2_index + 3]

# ---- CONFIG 3 ----
# Determine closest temperature from table
closest_temperature_config3_index = np.argmin(abs(config3_selected_data[:,0] - temperature))
temp = config3_selected_data[:,0]
original_temp_data = temp[closest_temperature_config3_index]
temp[closest_temperature_config3_index] = 1000
closest_temperature_config3_index1 = np.argmin(abs(temp - temperature))
temp[closest_temperature_config3_index] = original_temp_data


# First values
weight_config3_first = config3_selected_data[closest_temperature_config3_index, closest_runway_length_config3_index]
oat_config3_first = config3_selected_data[closest_temperature_config3_index, 0]
v1_config3_first = config3_selected_data[closest_temperature_config3_index, closest_runway_length_config3_index + 1]
vr_config3_first = config3_selected_data[closest_temperature_config3_index, closest_runway_length_config3_index + 2]
v2_config3_first = config3_selected_data[closest_temperature_config3_index, closest_runway_length_config3_index + 3]
# Second values
weight_config3_second = config3_selected_data[closest_temperature_config3_index1, closest_runway_length_config3_index]
oat_config3_second = config3_selected_data[closest_temperature_config3_index1, 0]
v1_config3_second = config3_selected_data[closest_temperature_config3_index1, closest_runway_length_config3_index + 1]
vr_config3_second = config3_selected_data[closest_temperature_config3_index1, closest_runway_length_config3_index + 2]
v2_config3_second = config3_selected_data[closest_temperature_config3_index1, closest_runway_length_config3_index + 3]

# Some printing

# print("CONFIGURATION 1, MAX TOW:")
# print(weight_config1_first, oat_config1_first, v1_config1_first, vr_config1_first, v2_config1_first)
#
# print("CONFIGURATION 2, MAX TOW:")
# print(weight_config2_first, oat_config2_first, v1_config2_first, vr_config2_first, v2_config2_first)
#
# print("CONFIGURATION 3, MAX TOW:")
# print(weight_config3_first, oat_config3_first, v1_config3_first, vr_config3_first, v2_config3_first)
